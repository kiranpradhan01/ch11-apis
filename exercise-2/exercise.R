...
# a list consisting of a data frame of reviews
class(results)
...
colnames(reviews)
hp_recent_review <- reviews[1,]
hp_headline <- hp_recent_review$headline
hp_summary <- hp_recent_review$summary_short
hp_link <- hp_recent_review$link.url
